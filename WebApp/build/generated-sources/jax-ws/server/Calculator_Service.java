 ...
 * 
 */
@WebServiceClient(name = "Calculator", targetNamespace = "http://Server/", wsdlLocation = "http://localhost:8080/WebApp/Calculator?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CALCULATOR_QNAME = new QName("http://Server/", "Calculator");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/WebApp/Calculator?wsdl");
    ...
    public Calculator getCalculatorPort() {
        return super.getPort(new QName("http://Server/", "CalculatorPort"), Calculator.class);
    }
    ...
    public Calculator getCalculatorPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://Server/", "CalculatorPort"), Calculator.class, features);
    }
